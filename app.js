...
// refferce to the new student that was created
// 2. What is "this" when joe.scopeArrow() is invoked?
// In the console log it refferce to the window 
// 3. Explain why "this" is different when an arrow function is used.
// I think it's diffrent because when using this in arrow funtion it always equals to the outer funtion.